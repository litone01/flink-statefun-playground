...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", default="itemId", type=parse)
    parser.add_argument("--path", default=os.path.join(PWD, "restock.json"), type=str)
    parser.add_argument("--topic", default="inventory-restock-events", type=str)
