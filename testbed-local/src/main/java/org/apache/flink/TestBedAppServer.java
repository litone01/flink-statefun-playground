...
public final class TestBedAppServer {
  ...
  public static void main(String[] args) {
    ...
    StatefulFunctionSpec maxCountFn =
            StatefulFunctionSpec.builder(MaxCountFn.TYPE)
                    .withValueSpec(MaxCountFn.MAX_COUNT)
                    .withSupplier(MaxCountFn::new)
                    .build();
    ...
    functions.withStatefulFunction(wordCountFn)
            .withStatefulFunction(maxCountFn);
